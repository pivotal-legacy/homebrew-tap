...
class Tcserver < Formula
  ...
  url 'http://public.pivotal.com.s3.amazonaws.com/releases/tcserver/3.1.2.RELEASE/tcserver-3.1.2.RELEASE-developer.tar.gz'
  sha1 'e6a7d8d9d4d25516c1ddf4e46abf7fc7be206e7c'
  version "3.1.2"
